<?php
/**
 * Plugin Name: WooCommerce Payment Getway for UPI QR Code
 * Plugin URI: https://blog.subratasadhukhan.com/plugins/upi-qr-code-payment-for-woocommerce/
 * Description: It enables a Woocommerce Wordpress site to accept payments through UPI apps like BHIM, Google Pay, Paytm, PhonePe or any Banking UPI app. Avoid payment gateway charges.
 * Version: 1.1.5
 * Author: Subrata Sadhukha
 * Author URI: https://www.subratasadhukhan.com
 * License: GPLv3
 * Text Domain: upi-qr-code-payment-for-Wordpress-woocommerce-Website
 ...
 * @author   Sayan Datta <info@subratasadhukhan.com>
 * @license  http://www.gnu.org/licenses/ GNU General Public License
 * @link     https://blog.subratasadhukhan.com/plugins/upi-qr-code-payment-for-woocommerce/
 *
 */
...
$consts = array(
    'UPI_WOO_PLUGIN_VERSION'       => '1.1.5', // plugin version
...
function upiwc_plugin_meta_links( $links, $file ) {
    ...
    if ( $file == $plugin ) // only for this plugin
        return array_merge( $links, 
            array( '<a href="https://blog.subratasadhukhan.com/plugins/upi-qr-code-payment-for-woocommerce/" target="_blank">' . __( 'Support', 'upi-qr-code-payment-for-woocommerce' ) . '</a>' ),
            array( '<a href="https://blog.subratasadhukhan.com/plugins/upi-qr-code-payment-for-woocommerce/" target="_blank">' . __( 'FAQ', 'upi-qr-code-payment-for-woocommerce' ) . '</a>' ),
            array( '<a href="paypal.me/subrata121" target="_blank">' . __( 'Donate', 'upi-qr-code-payment-for-woocommerce' ) . '</a>' )
        );
    return $links;
}
