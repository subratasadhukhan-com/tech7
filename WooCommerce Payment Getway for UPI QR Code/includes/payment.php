	...
	class WC_UPI_Payment_Gateway extends WC_Payment_Gateway {
		...
		public function init_form_fields() {
			...
			$this->form_fields = array(
				...
				'transaction_id' => array(
					'title'       => __( 'Transaction ID:', 'upi-qr-code-payment-for-woocommerce' ),
					'type'        => 'select',
		...
		public function payment_scripts() {
			...
			if ( is_checkout() ) {
				...
				wp_enqueue_script( 'upiwc-selectize-js', plugins_url( 'js/selectize.min.js' , __FILE__ ), array( 'jquery' ), '0.12.6', false );
			}
		...
		public function process_payment( $order_id ) {
			...
			if ( ! empty( $upi_address ) ) {
			    update_post_meta( $order->get_id(), '_transaction_id', $upi_address );
			}
		...
		public function generate_qr_code( $order_id ) {
			...
			wp_localize_script( 'upiwc-js', 'upiwc_params',
                array( 
					...
					'transaction_text'  => apply_filters( 'upiwc_transaction_id_text', __( 'Enter 12-digit Transaction ID:', 'upi-qr-code-payment-for-woocommerce' ) ),
			    ...
			    <section class="woo-upi-section">
				    <div class="upiwc-info">
				        ...
				        <div id="js_qrcode">
					    	...
					    	<div id="upiwc-qrcode"<?php echo isset( $style ) ? $style : ''; ?>></div>
